...
export function CompanyDetailPage({ id }: { id: number }) {
  ...
  const PAGE_SIZE = 50;
  const { data, isLoading, isError, refetch } = useCompany(id, (page - 1) * PAGE_SIZE);
