...
export function ProfilePage() {
  ...
  if (!candidate) return <div className="mx-auto max-w-2xl px-5 py-20 sm:px-8"><EmptyState title="Your profile is waiting" body="Build a profile once and Career Radar will keep your priorities close to every recommendation." action={c("onboarding")} onAction={() => router.push(`/${locale}/onboarding`)} /></div>;
