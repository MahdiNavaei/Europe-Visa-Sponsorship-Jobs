...
export function DashboardPage() {
  ...
  let syncLabel = catalogStatus?.state === "syncing" ? t("syncing") : catalogStatus?.state === "failed" ? t("syncFailed") : catalogStatus?.last_successful_sync ? t("lastSync", { value: new Date(catalogStatus.last_successful_sync).toLocaleString(locale) }) : t("syncNotRecorded");
